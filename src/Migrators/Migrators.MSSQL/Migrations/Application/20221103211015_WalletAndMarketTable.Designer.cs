...
namespace Migrators.MSSQL.Migrations.Application
{
    ...
    [Migration("20221103211015_WalletAndMarketTable")]
    partial class WalletAndMarketTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Crypto.Market", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("CountDecimalNumberCryptoCurency")
                        .HasColumnType("int");

                    b.Property<int>("CountDecimalNumberInPosition")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Crypto.Wallet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Crypto.Wallet", b =>
                {
                    b.HasOne("FSH.WebApi.Domain.Crypto.Market", "Market")
                        .WithOne("Wallet")
                        .HasForeignKey("FSH.WebApi.Domain.Crypto.Wallet", "MarketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
